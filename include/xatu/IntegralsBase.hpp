...
class IntegralsBase {
    ...
    public:
        ...
        // Number of chemical species in the motif (unit cell).
        ...
        // the last element is an index representing the chemical species.
        ...
        // Vector storing the number of shells for each atomic species.
    ...
    protected:
        ...
        std::vector<double> FAC2fun(const bool basis_id);
        // Method to build the vector FAC12[orb] attribute.
        void FAC12fun(const int maxL, const bool basis_id);
        ...
        // Method to compute the E^{i,i'}_{t} coefficients in the expansion Hermite Gaussian expansion 
