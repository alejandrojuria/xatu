...
int main(int argc, char* argv[]){
    ...
    std::string filename_wf = "k_wf.out";
    ...
    /*if(useCenteredMeshK){
        ...
        arma::rowvec K = norm/sqrt(3)*(bulkExciton.reciprocalLattice.row(0)/2. -
                                bulkExciton.reciprocalLattice.row(1)/2.)/arma::norm(
                                bulkExciton.reciprocalLattice.row(0)/2. -
